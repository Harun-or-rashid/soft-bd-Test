            ...
            <table class="table text-purple table-bordered table-hover">
                ...
                @foreach($departments as $department)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('department.show',$department->id)}}" class="btn btn-xs btn-success" title="View"><i
                                        class="fa fa-eye"></i></a>
                            <a href="{{route('department.edit',$department->id)}}" class="btn btn-xs btn-danger" title="Edit"><i
